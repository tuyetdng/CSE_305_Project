...
//    private DoctorManagement doctorManagement;
    ...
    //Constructors
    public DialogPatientBookComfirm(java.awt.Frame parent, boolean modal, DoctorManagement doctorManagement, Doctor doctor, Patient_FormAppointment formAppoitment) {
        super(parent, modal);
        initComponents();
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(txtPatientConfirmAge, javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(txtPatientConfirmGender, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE))))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
    ...
    public void fillData(Doctor doctor) {
        lblPatientDoctorExpComfirm.setText(doctor.getExperience() + " Years");
    ...
    public void bookAppoitment(Doctor doctor) {
        Booking booking = new Booking(doctor, txtPatientConfirmName.getText(), txtPatientConfirmContact.getText(), txtPatientConfirmGender.getText(), txtPatientConfirmAge.getText(), txaPatientConfirmProblem.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                DialogPatientBookComfirm dialog = new DialogPatientBookComfirm(mf, true, doctorManagement, doctor, formAppointment);
